  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {selectedImg && (
          <motion.div
            ...
            style={{ backdropFilter: "blur(18px)", backgroundColor: "rgba(0,0,0,0.75)" }}
          ...
          >
            ...
            >
              <button
                ...
                onMouseEnter={(e) => ((e.currentTarget as HTMLButtonElement).style.backgroundColor = "#b8972e")}
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <main className="relative z-10 flex flex-col items-center justify-center h-[72vh] text-center px-6">
          ...
          <motion.p
            ...
            style={{ color: "#ffffff", textShadow: "0 4px 10px rgba(212,175,55,0.4)" }}
          >
            Welcome to
          </motion.p>
          ...
          >
            <div
              className="backdrop-blur-md p-3 px-8 rounded-2xl border shadow-2xl mb-4"
              style={{
          ...
          <motion.div
            ...
            className="mt-10 backdrop-blur-md p-4 px-10 rounded-2xl shadow-xl"
            style={{
      ...
      <section
        ...
        style={{ backgroundColor: "rgba(212,175,55,0.04)", borderTop: "1px solid rgba(212,175,55,0.1)" }}
      >
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <h2
              className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none text-white"
            >
              Every Frame <br />
              <span style={{ color: "#D4AF37" }}>is Art</span>
            </h2>
            <p className="leading-relaxed text-lg font-light text-white/60">
              Based in the heart of Lagos, TOPXCM is a luxury boutique studio specialising in cinematic
            ...
            >
              <div className="space-y-1">
                <p className="text-[10px] font-bold tracking-[0.5em] uppercase" style={{ color: "#D4AF37" }}>
                  Inquiries
                </p>
                <p className="text-white font-serif italic text-lg tracking-wide">+234 806 158 7993</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-bold tracking-[0.5em] uppercase" style={{ color: "#D4AF37" }}>
                  Social
                </p>
                <p className="text-white font-serif italic text-lg tracking-wide">@topstudios1</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer
        ...
        style={{ borderTop: "1px solid rgba(212,175,55,0.08)", backgroundColor: "rgba(0,0,0,0.9)" }}
      >
        <div className="flex flex-col items-center gap-6">
          <div
            ...
            style={{ background: "linear-gradient(to bottom, #D4AF37, transparent)" }}
          />
          <p className="text-[9px] tracking-[1.2em] uppercase font-medium" style={{ color: "rgba(255,255,255,0.2)" }}>
