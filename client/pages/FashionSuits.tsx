  ...
  return (
    <div className="min-h-screen bg-[#D9EAF0] text-slate-800 overflow-x-hidden">
      ...
      <div className="pt-24 px-5 py-10 border-b border-[#1E3A8A]/5 bg-white/20">
        <h1 className="text-3xl md:text-5xl font-serif italic text-[#1E3A8A] mb-2">Suits</h1>
      ...
      <main className="px-4 py-8">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            <p className="text-[#1E3A8A]/40 text-lg font-serif italic">The atelier is preparing new pieces.</p>
          </div>
        ) : (
