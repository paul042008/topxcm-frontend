  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-6 md:px-10 py-5 border-b border-white/5 bg-black/80 backdrop-blur-xl">
        ...
        {/* ─── Menu is placed outside this header ─── */}
      </header>

      {/* ─── MENU (fixed, independent) ─── */}
      <div className="fixed top-4 right-4 md:right-8 z-[100]">
        <RealEstateMenu
      ...
      <main className="px-6 md:px-16 py-16 max-w-3xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 bg-white/5">
              <img
                ...
                alt="XCM Real Estate properties"
                className="w-full h-full object-cover"
                onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }}
              />
            </div>
        ...
        {/* Location */}
        <div
          className="flex items-start gap-4 px-6 py-5 rounded-2xl border border-white/10 bg-white/5"
        >
          <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 mt-0.5 border border-[#B0D4E8]/30 bg-[#B0D4E8]/10">
            ...
            {[
              ...
              >
                <div>
                  ...
                  <p className="text-white/40 text-xs uppercase tracking-widest mt-1">Tap to WhatsApp</p>
                </div>
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              <a
                ...
                className="group flex items-center gap-5 px-6 py-5 rounded-2xl border border-white/10 bg-white/5 transition-all duration-300 hover:border-[#B0D4E8]/40"
              >
                <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-[#B0D4E8]/10">
                  {s.icon}
                </div>
      ...
      <footer className="py-20 text-center border-t border-white/5 mt-16">
        <div className="flex flex-col items-center gap-4">
          <div className="h-10 w-[1px] bg-gradient-to-b from-[#B0D4E8] to-transparent" />
          <p className="text-[8px] tracking-[1em] uppercase text-white/15">
            © 2026 XCM Real Estate • Lagos, Nigeria
          </p>
        </div>
      </footer>
