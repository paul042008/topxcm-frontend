        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-wrap items-center justify-center gap-6 mb-10">
            ...
            >
              ...
              <span className="text-[9px] uppercase tracking-[0.3em]">@topstudios1</span>
            </a>

            {/* Facebook */}
            <a
              href="https://www.facebook.com/topfilmzz1"
              target="_blank"
              rel="noreferrer"
              className="group flex items-center gap-3 text-white/40 hover:text-white transition-colors"
              aria-label="Facebook"
            >
              ...
              <span className="text-[9px] uppercase tracking-[0.3em]">@topfilmzz1</span>
            </a>
          </div>
