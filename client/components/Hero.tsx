    ...
    <>
      ...
      >
        ...
        <div className="relative flex flex-col items-center justify-center px-6 text-center mt-32 z-10 pointer-events-none">
          <p
            className={`pointer-events-auto text-sm md:text-lg text-[#D4AF37] italic font-serif whitespace-nowrap transition-all duration-700 ${
          ...
          <h1
            className={`pointer-events-auto text-4xl md:text-6xl font-sans font-black tracking-[0.2em] text-white mt-3 mb-3 transition-all duration-700 ${
        ...
        <div
          className={`relative z-10 w-full max-w-5xl px-6 pb-24 transition-opacity duration-1000 ${
        ...
        >
          <div className="flex flex-col gap-8">
            <div className="flex justify-between items-center px-2 md:px-10 gap-2">
              <Link
                to="/photography"
                className="group relative overflow-hidden flex items-center justify-center px-4 py-3 md:px-8 border border-white/10 rounded-full animate-[slideInLeft_1s_ease-out_2s_both] backdrop-blur-sm"
              >
              ...
              <Link
                to="/fashion"
                className="group relative overflow-hidden flex items-center justify-center px-4 py-3 md:px-8 border border-white/10 rounded-full animate-[slideInRight_1s_ease-out_2s_both] backdrop-blur-sm"
              >
            ...
            <div className="flex justify-center">
              <Link
                to="/real-estate"
                className="group relative overflow-hidden flex items-center justify-center px-6 py-3 md:px-10 border border-white/10 rounded-full animate-[slideInUp_1s_ease-out_2.3s_both] backdrop-blur-sm"
              >
